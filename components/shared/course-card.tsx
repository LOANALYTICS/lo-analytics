            ...
            <p><span className='font-semibold'>Course Code : </span><span className='capitalize'>{template.course_code}</span></p>
            {
              !isQP && (
                <>
                  ...
                  <p><span className='font-semibold'>Semester : </span><span className='capitalize'>{template.semister == 1 ? 'First Semester' : 'Second Semester'} ({template?.academic_year})</span></p>
                </>
              )
            }
        ...
        <>
          <div className='flex relative justify-between items-center border border-gray-300 shadow-sm p-3 rounded-md text-[13px]'>
            <div className='flex flex-col gap-1'>
              ...
              <p>Academic Year : <span className='capitalize'>{template.academic_year} ({template?.academic_year})</span></p>
            </div>
            <div className='absolute right-3 bottom-3 space-x-2'>
              <DropdownMenu>
